...
/**
 * Created by Avishek on 6/22/2015.
 */
public class CompletedAdapter extends ArrayAdapter<ShipmentItem> {

    private LayoutInflater inflater;
    private Context mContext;

    public CompletedAdapter(Context context,
                          ArrayList<ShipmentItem> completedList) {
        // TODO Auto-generated constructor stub
        super(context, R.layout.completed_row, R.id.tvShipmentTitle,
                completedList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.completed_row, null);
