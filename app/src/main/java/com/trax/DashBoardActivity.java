 ...
 */
public class DashBoardActivity extends ActionBarActivity implements BackgroundTaskInterface{
    ...
    private void initialize(){
        ...
        _pref = new Pref(DashBoardActivity.this);
        _connectionCheck = new ConnectionCheck(DashBoardActivity.this);
        _GpsTrackerSecond = new GPSTrackerSecond(DashBoardActivity.this);
        db = new DBAdapter(DashBoardActivity.this);
        ...
        llGoOnline = (LinearLayout) findViewById(R.id.llGoOnline);
        llGoOfflineMain = (LinearLayout) findViewById(R.id.llGoOfflineMain);
        llGoOffline = (LinearLayout) findViewById(R.id.llGoOffline);
            ...
            public void onClick(View v) {
                ...
                if(_pref.getLoginFlag().equals("3")){
                    ...
                    if(_connectionCheck.isGPSEnabled()) {
                        ...
                        Intent intent = new Intent(DashBoardActivity.this, TraxActivity.class);
    ...
    private void setPieChartData() {
        ...
        if(Constant.pendingList.size()+ Constant.intransitList.size()+ Constant.completedList.size()+ Constant.rejectedList.size() == 0){

            //l.setEnabled(false);

            /*new SweetAlertDialog(DashBoardActivity.this, SweetAlertDialog.WARNING_TYPE)
                    .setTitleText("Alert...")
                    .setContentText("Data not available!! Want to Refresh??")
                    .setCancelText("No, Cancel")
                    .setConfirmText("Yes, Sure")
                    .showCancelButton(true)
                    .setCancelClickListener(new SweetAlertDialog.OnSweetClickListener() {
    ...
    private void getShipmentListFromWS(){
        ...
        startService(new Intent(DashBoardActivity.this,
        ...
        if (_connectionCheck.isNetworkAvailable()) {
            ...
            try {
                ...
                async.taskInterface = DashBoardActivity.this;
            ...
            if (jsonStr != null) {
                ...
                try {
                    ...
                    if (errCode.equalsIgnoreCase("0")) {
                        ...
                        stopService(new Intent(DashBoardActivity.this, TraxService.class));
